...
class TransaksiController extends Controller {
	...
	public function nota(Request $r)
	{
		...
		return view('transaksi.tnota')->with('uang_total',$uang_total)->with('uang_bayar', $uang_bayar)->with('uang_kembali', $uang_kembali)->with('kategoris',$katjasa)->with('jasas', $jasa)->with('transaksip', $transaksip)->with('pelanggan', $pelanggan);
	}
	...
	public function notab(Request $r)
	{
		...
		return view('transaksi.tnotab')->with('uang_total',$uang_total)->with('uang_bayar', $uang_bayar)->with('uang_kembali', $uang_kembali)->with('kategoris',$katbarang)->with('barangs', $barang)->with('transaksib', $transaksib)->with('pelanggan', $pelanggan);
	}
	...
	public function notajasa(Request $r,$kode_penjualan)
	{
		...
		return view('transaksi.notajasa',['tproduk'=>$tproduk,'transaksip'=>$transaksip,'pelanggan'=>$pelanggan,'grandtotal'=>$grandtotal,'uang_bayar'=>$uang_bayar,'uang_kembali'=>$uang_kembali]);
	}
	...
	public function notabarang(Request $r,$kode_penjualan)
	{
		...
		return view('transaksi.notabarang',['tbarang'=>$tbarang,'transaksib'=>$transaksib,'pelanggan'=>$pelanggan,'grandtotal'=>$grandtotal,'uang_bayar'=>$uang_bayar,'uang_kembali'=>$uang_kembali]);
	}
}
