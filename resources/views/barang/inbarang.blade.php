...
@section('content')
 <h3 class="page-title">
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Input Data Produk Handphone</h4>
                            <div class="tools">
            ...
            {{ $randomkode}}
                                ...
                                <div class="control-group ">
                                    <label for="newsletter" class="control-label">Merek Hp</label>
                                    <div class="controls">
