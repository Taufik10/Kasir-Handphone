   ...
   <div id="header" class="navbar navbar-inverse navbar-fixed-top">
       ...
       <div class="navbar-inner">
           <div class="container-fluid" style="background-color: #262626;">
               ...
               <div class="sidebar-toggle-box hidden-phone" style="background-color: #262626;">
                   <div class="icon-reorder tooltips" data-placement="right" data-original-title="Toggle Navigation"> <img alt="Aira Phone" /></div>
               </div>
               <!--END SIDEBAR TOGGLE-->
               <!-- BEGIN LOGO -->
               <a class="brand" href="/">
          ...
          <ul class="sidebar-menu">
             ...
             <!--  <li class="sub-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="/ritbar">Transaksi Pembelian HP</a></li>
